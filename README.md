...
Led a team of 10 blockchain engineers over 4 years at SoluLab — sprint planning, architecture reviews, code quality, and delivery across concurrent projects in fintech, real estate, and supply chain. At the founding-engineer level, I've been involved in custody vendor evaluation (Fireblocks, BitGo), smart contract audit preparation, and engineering hiring. I don't separate architecture from delivery.
 
---
 
### Stack I reach for
 
`Solidity` `TypeScript` `Node.js` `Fastify` `ethers.js` `ERC-3643` `ERC-721`  
`Aave` `Uniswap` `MongoDB` `PostgreSQL` `Redis` `BullMQ`  
`AWS` `Docker` `Kubernetes` `Fireblocks` `Golang` `Rust`
 
---
 
**[LinkedIn](https://linkedin.com/in/parthkaloliya)** · **[parthkaloliya.com](https://parthkaloliya.com)** · kaloliya@gmail.com
